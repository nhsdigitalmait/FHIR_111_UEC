...
sed -i -e 's|TKW_ROOT/|/home/service/TKW/|g' ${configDirectory}/tkw-x_cleartext.properties
...
sed -i -e "/^tks.validator.hapifhirvalidator.assetdir.ignore/c\tks.validator.hapifhirvalidator.assetdir.ignore /home/service/fhir/examples/" ${configDirectory}/tkw-x_cleartext.properties
...
sed -i -e "/^tks.validator.hapifhirvalidator.profileversionfilelocation/c\tks.validator.hapifhirvalidator.profileversionfilelocation /home/service/fhir/package.json" ${configDirectory}/tkw-x_cleartext.properties
